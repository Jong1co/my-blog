...
const PostCard = ({ title, description, date, category, path, featured, thumbnail }: PostCardInfo) => {
  return (
    <Link href={`/post/${path}`}>
      <li className="flex flex-col w-full duration-150 ease-in-out border rounded-lg cursor-pointer mobile:h-[164px] mobile:flex-row bg-neutral-30 border-neutral-70 hover:bg-neutral-40">
        {thumbnail !== null && (
          <Image
            src={thumbnail}
            alt={path}
        ...
        <div className="flex flex-col w-full h-[170px] gap-3 p-4 overflow-hidden">
